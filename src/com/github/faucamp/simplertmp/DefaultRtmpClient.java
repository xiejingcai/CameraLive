...
import com.github.faucamp.simplertmp.io.RtmpConnectionPlay;
...
public class DefaultRtmpClient implements RtmpClient {
    ...
    public DefaultRtmpClient(String host, int port, String application) {
        rtmpConnection = new RtmpConnectionPlay(host, port, application);
    }
    ...
    public DefaultRtmpClient(String url) {
        ...
        if (matcher.matches()) {
            ...
            rtmpConnection = new RtmpConnectionPlay(matcher.group(1), port, matcher.group(4));
        } else {
